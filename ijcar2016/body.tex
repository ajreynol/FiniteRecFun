...
Given a type of infinite streams constructed by
...
It is even possible to mix recursion and corecursion in the same total function
...
\emph{acyclic} objects, such as the $\con{e}$ function introduced above.
Nonetheless, admissibility is still useful if the problem does not refer to
$\con{g}$ or $\con{e}$, because it tells us that we can safely ignore these
