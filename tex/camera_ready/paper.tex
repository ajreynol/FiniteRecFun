...
$\bigwedge_{i=1}^m\, \fargx{\con{f}}{i}(a) \teq s_i$
with $\vec s = (s_1,\ldots,s_m)$.
...
the tuple of uninterpreted functions $\vecfarg{\con{f}}$ has the argument
tuple $\vec s$ in its range.
%ct 
% 
...
\end{equation}
%
The universal quantification in formula~(\ref{eq:ex-after}) is over an uninterpreted
