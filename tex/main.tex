...
In total, \ziiib manages to find only 11 benchmarks to be satisfiable,
...
the configuration \cvci is the clear winner, finding 318 total benchmarks to be unsatisfiable.
...
In total, \cvcf finds 331 of the 885 benchmarks to be satisfiable, including 9 benchmarks in the original {\bench leon} benchmark set.
The performance of \ziiib for counterexamples also improves drastically, as it solves 112 satisfiable,
including 10 that were unsolved by \cvcf.
...
This number is 2 fewer than \cvcd, which solves 211 unsatisfiable.
...
\footnote{The exception here is \cvci, which makes use of type
...
Both \ziiib and \cvcf were able to find a large number of counterexamples after the translation,
