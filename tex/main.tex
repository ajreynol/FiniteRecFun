...
\newcommand{\I}{\mathcalx{I}} %%% there's no difference, right? --JB  need to simultaneously refer to 2 different interpretations --ajr.
...
\newcommand{\fargx}[2]{\concret_{#1,\vthinspace#2}}
...
then $\I$ satisfies a set of $\Sigma$-literals $L$ that entail $\varphi$,
and $\I$ satisfies
