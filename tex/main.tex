...
in axioms specifying well-behaved recursive functions, including terminating,
tail-recursive, and productive functions. An empirical evaluation confirms that
the approach works well on benchmarks from various sources. The translation is
implemented as a preprocessor in the solver CVC4.
\end{abstract}
