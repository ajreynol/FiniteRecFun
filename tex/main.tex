...
up to $x$. The formula $\varphi$ is in definitional form with
...
The resulting existential $\exists b : {\fargtype{\con{s}}}.\;\, (\farg{\con{s}}( b ) \teq \con{c}-1)$ 
...
Hence, a model of formula~(\ref{eq:ex-after}) that interprets $\con{c}$ as $n$ must also satisfy the following formula $\psi$:
%
