...
$\forall \vec x.\;\, \con{f}( \vec x ) \teq t$ for some $t$. We will write $\forall \vec
...
For instance, $\{ \forallf{\con{f}} \vec x.\;\, \con{f}( x ) \teq 0 \}$ is well-specified,
...
$\{ \forallf{\con{f}} x^\sortint.\;\, \con{f}( x ) \teq \con{f}( x - 1 ) \}$ or even $\{ \forallf{\con{f}} x.\;\, \con{f}( x ) \teq \con{f}( x ) \}$ are well-specified.
\ajr{revise}
...
For instance, the formula $\forall x\typ{\sortint}.\;\, \con{f}( x ) \teq g( x ) + 5$ 
