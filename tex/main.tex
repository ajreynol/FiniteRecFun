...
infinite types. This paper introduces a translation that eliminates infinite
...
the solver assumes functions introduced using the \texttt{define-fun-rec} command are
admissible and translates them accordingly (Section~\ref{sec:front-end}).
