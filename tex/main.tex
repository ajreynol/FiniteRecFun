...
The configuration {\bf cvc4+f} runs a finite model finding procedure~\ref{ReyEtAl-1-RR-13}.
The last configuration {\bf cvc4+i} incorporates techniques for automating inductive reasoning in SMT~\ref{reynolds-kuncak-2015}.
