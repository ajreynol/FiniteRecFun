...
and a function $\lite$ of type $\Bool \times \sigma \times \sigma \rightarrow \lite$ for each $\sigma \in \ssorts{\Sigma}$.
...
Since $\I$ satisfies $\varphi$ and due to our construction of $\conv( \varphi )$, we conclude $\J$ is a model of $\conv( \varphi )$.
